...
<!--
   -O mapa de Tosi Colombina ainda é uma cartografia clássica,
   -apresentada em termos de rotas e pousos.
   -O mapa da comissão de limites, seu coetâneo,
   -representa a cartografia moderna, que busca representar
   -a geometria de extensões territoriais abstratas.
   -->
...
![Implantação do Museu Nacional de Machado de Castro, Coimbra, ocupando o antigo palácio Episcopal junto à igreja de S. Salvador, sobre a implantação respectivamente do fórum e do templo imperial romano, no sítio presumido duma povoação castreja](){#fig:machado}
...
<!--De Eschwege à natimorta real academia de artes e ofícios-->
